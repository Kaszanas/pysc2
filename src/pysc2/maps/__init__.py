...
from pysc2.maps import ladder as ladder
from pysc2.maps import lib as lib
from pysc2.maps import melee as melee
from pysc2.maps import mini_games as mini_games
